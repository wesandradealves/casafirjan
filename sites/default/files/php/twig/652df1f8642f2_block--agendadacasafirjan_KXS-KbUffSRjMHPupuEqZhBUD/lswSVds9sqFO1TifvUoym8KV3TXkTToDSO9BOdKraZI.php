...
class __TwigTemplate_5f4ce08680e49c080d981d1ae1540f64 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container pt-5 pb-5\">
        <div class=\"d-flex flex-wrap align-items-stretch\">
            ...
            $context['_seq'] = twig_ensure_traversable(twig_slice($this->env, ($context["new_group"] ?? null), 0, 5));
            foreach ($context['_seq'] as $context["data"] => $context["eventos"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["evento"]) {
                    ...
                    // line 53
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_join_filter(twig_split_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["evento"], "field_hora_de_inicio", [], "any", false, false, true, 53), 53, $this->source), ":"), "h"), "html", null, true);
                    echo " 
...
";
    ...
    {
        return array (  171 => 86,  162 => 81,  154 => 75,  152 => 70,  150 => 68,  147 => 66,  140 => 64,  129 => 59,  124 => 57,  118 => 54,  114 => 53,  109 => 51,  102 => 47,  98 => 46,  92 => 44,  88 => 43,  83 => 42,  78 => 41,  76 => 40,  73 => 36,  71 => 35,  69 => 33,  67 => 24,  63 => 17,  59 => 15,  54 => 13,  41 => 2,  39 => 1,);
    }
        ...
        <div class=\"d-flex flex-wrap align-items-stretch\">
            ...
            <div class=\"col-lg-8 ps-0\">
                <section class=\"blocoAgenda\" >
                    ...
                    {% for data, eventos in new_group|slice(0, 5) %}
                                ...
                                <div class=\"d-block evento\" onclick=\"window.location = '{{evento.url}}'\">
                                    ...
                                    <div class=\"evento--info d-block p-2 p-md-4 pt-3 pb-3\">
                                        <span class=\"d-flex align-items-center\">
                                            ...
                                            <span class=\"info ps-2 ps-md-4\">
                                                <strong>Horário:</strong> {{evento.field_hora_de_inicio|split(':')|join('h')}} 
...
{% endif %}  ", "themes/casa_firjan/templates/blocks/block--agendadacasafirjan.html.twig", "/home/casafirjancityco/public_html/themes/casa_firjan/templates/blocks/block--agendadacasafirjan.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 1, "for" => 41);
        static $filters = array("escape" => 13, "slice" => 41, "join" => 53, "split" => 53, "raw" => 59);
        static $functions = array("drupal_region" => 81);

        try {
            $this->sandbox->checkSecurity(
                ['if', 'for'],
                ['escape', 'slice', 'join', 'split', 'raw'],
                ['drupal_region']
            );
