...
class __TwigTemplate_73f06e0a21199261b61bdeaf1e00286f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div{{ attributes.addClass(message and message == 'A página solicitada não foi encontrada.' ? ['d-block mt-5 pt-5 text-center'] : '') }}>
  ...
  {% endblock %}
{% endif %}
</div>", "themes/casa_firjan/templates/blocks/block--system-main-block.html.twig", "/home/casafirjancityco/public_html/themes/casa_firjan/templates/blocks/block--system-main-block.html.twig");
    }
